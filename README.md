# com-chilipeppr-workspace-CNC
A ChiliPeppr Workspace CNC.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / CNC
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-CNC |
| Name                  | Workspace / CNC |
| Description           | A ChiliPeppr Workspace CNC. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/Franzt151/workspace-sample/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/franzt151/workspace-sample |
| Github URL            | http://github.com/Franzt151/workspace-sample |
| Test URL              | https://preview.c9users.io/franzt151/workspace-sample/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/Franzt151/workspace-sample/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-CNC"], // the id you gave your workspace
      function(myWorkspaceCNC) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / CNC just got loaded.", myWorkspaceCNC);
        myWorkspaceCNC.init();
      }
    );
  }
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-CNC"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / CNC"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace CNC."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/Franzt151/workspace-sample/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/franzt151/workspace-sample"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/Franzt151/workspace-sample"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-sample-franzt151.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
